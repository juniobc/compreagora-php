...
class RequisicaoController extends AbstractActionController{
	...
	public function cadastroProdutoAction(){
		...
		$this->uri = 'http://quero-c9-juniobc.c9.io/htdocs/desenvolvimento/public/webservice/requisicao/cadastroproduto';
		$this->arquivo = 'public/soap/wsdl/cadastroproduto.wsdl';
		$this->smObjeto = 'cadastroprodutoWS';
		$this->_WSDL_URI = "http://quero-c9-juniobc.c9.io/htdocs/desenvolvimento/public/webservice/requisicao/cadastroproduto?wsdl";
	...
	public function consultaBancoAction(){
		...
		$this->uri = 'http://quero-c9-juniobc.c9.io/htdocs/desenvolvimento/public/webservice/requisicao/consultabanco';
		$this->arquivo = 'public/soap/wsdl/consultabanco.wsdl';
		$this->smObjeto = 'consultabancoWS';
		$this->_WSDL_URI = "http://quero-c9-juniobc.c9.io/htdocs/desenvolvimento/public/webservice/requisicao/consultabanco?wsdl";
