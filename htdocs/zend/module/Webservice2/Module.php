...
use Webservice2\Model\ProdutoTable;
use Webservice2\Model\Endereco;
use Webservice2\Model\EnderecoTable;
use Webservice2\Model\Empresa;
use Webservice2\Model\EmpresaTable;
use Webservice2\Model\Departamento;
use Webservice2\Model\DepartamentoTable;
use Webservice2\Model\Entradaproduto;
use Webservice2\Model\EntradaprodutoTable;
...
class Module
{
	...
	public function getServiceConfig()
    {
         return array(
             'factories' => array(
                 'Webservice2\Model\ProdutoTable' =>  function($sm) {
				 ...
				 'Webservice2\Model\EnderecoTable' =>  function($sm) {
				 ...
				 'Webservice2\Model\EmpresaTable' =>  function($sm) {
				 ...
				 'Webservice2\Model\DepartamentoTable' =>  function($sm) {
				 ...
				 'Webservice2\Model\EntradaprodutoTable' =>  function($sm) {
